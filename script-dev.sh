# Obtenemos el listado de servidores de BD de desarrollo
az_servers=$(az postgres flexible-server list --output json --query "[? contains(resourceGroup,'DEV')].{NAME_SERVER: name, RESOURCE_GROUP: resourceGroup}")
